...
export default function Intro() {
  return (
    //everything in this project is related since its one page app
    //if everything is in a same semantic meaning its better to use section instead of the div
    <section className="mb-28 max-w-[50rem] text-center sm:mb-0">
      ...
      >
        <span className="font-bold">Hello, I'm Betül.</span> I'm a{" "}
      ...
      >
        ...
        active:scale-105 transition cursor-pointer border bırder-black/10"
          href="/CV.pdf"
          download
        >
          Download CV{" "}
        ...
        active:scale-105 transition cursor-pointer border bırder-black/10"
          href="https://www.linkedin.com/in/betul-akan/"
          target="_blank"
        >
          <BsLinkedin />
        </a>
        ...
        gap-2 rounded-full focus:scale-[1.15] hover:scale-[1.15] hover:text-gray-950
        active:scale-105 transition cursor-pointer border bırder-black/10"
          href="https://github.com/betulakan"
          target="_blank"
        >
          <BsGithub />
        </a>
