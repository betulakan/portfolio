...
export default function Project({
  ...
  const { scrollYProgress } = useScroll({
    target: ref,
    //shows when the bottom of the viewport crosses the top of the target 0 1
    //end when the bottom of the viewport has gone 33 percent beyond the end of the project
    offset: ["0 1", "1.33 1"],
  });
  ...
  return (
    ...
    >
     ...
     rounded-lg overflow-hidden sm:pr-8 relative sm:h-[20rem] mb-3 sm:mb-8 last:mb-0
